...
The model includes five continuous and one categorical predictors. Since the dataset contains a categorical variable, no transformation is needed. All six predictors are continuous and directly related to our question. They reflect government investment in health, education, and social equity, all of which may influence a country’s GDP.
...
GDP, percentage expenditure, and population are strongly right-skewed, with mostly low values. Schooling and income composition are slightly left-skewed, clustering at the high end. Income composition is also bimodal. Polio rates are highly left-skewed. Polio, income composition, and schooling show potential outliers at the low end. These patterns demonstrate how the predictors vary and help explain differences in GDP. 
