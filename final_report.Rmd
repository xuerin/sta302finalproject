...
$H_0$: All slope coefficients are equal to zero (the model has no explanatory power), $\beta_0 = \beta_1 = ... = \beta_k = 0, \forall k \in \mathbb{Z}^+$. 

$H_a$: At least one slope coefficient is non-zero (the model explains some variation in the response), $\exists i \in \mathbb{Z}^+ st. \beta_i \neq 0$.
...
Table 7: Final Model Summary Table at 0.05 Confidence Level
